...
export function CharacterInfoStep() {
  ...
  const selectClass =
    "w-full rounded-md border border-border bg-card px-3 py-2 text-lg text-foreground focus:outline-none focus:ring-1 focus:ring-primary";

  return (
    <div className="animate-fade-in space-y-6">
      <div>
        <h2 className="font-display text-2xl md:text-4xl text-gold-gradient">{tb.title}</h2>
        <p className="mt-1 text-lg text-muted-foreground">{tb.desc}</p>
      </div>

      <div className="grid gap-4 sm:grid-cols-2">
        {/* Name */}
        <div className="space-y-1.5">
          <label className="text-lg font-display text-primary">{tb.name}</label>
          <input
            type="text"
            value={state.name}
        ...
        {/* Gender */}
        <div className="space-y-1.5">
          <label className="text-lg font-display text-primary">{tb.gender}</label>
        ...
        {/* Weight */}
        <div className="space-y-1.5">
          <label className="text-lg font-display text-primary">{tb.weight}</label>
        ...
        {/* Height */}
        <div className="space-y-1.5">
          <label className="text-lg font-display text-primary">{tb.height}</label>
        ...
        {/* Age */}
        <div className="space-y-1.5">
          <label className="text-lg font-display text-primary">{tb.age}</label>
